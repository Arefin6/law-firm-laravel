      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 order-md-last ftco-animate">
              <p>
              <img src="{{asset($post->img)}}" alt="img" class="img-fluid">
              </p>
             
            
            <h2 class="mb-3">{{$post->description}}</p>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                ...
                <li><a href="{{route('category.single',['id' => $practice->id])}}">{{$practice->name}} <span class="ion-ios-arrow-forward"></span></a></li>
                @endforeach
              </div>
            </div>
